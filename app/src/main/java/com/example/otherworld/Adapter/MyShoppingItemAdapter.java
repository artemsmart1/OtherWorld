...
import com.example.otherworld.Database.CartItem;
...
public class MyShoppingItemAdapter extends RecyclerView.Adapter<MyShoppingItemAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int i) {
        ...
        holder.txt_shopping_item_price.setText(new StringBuilder("P").append(shoppingItemList.get(i).getPrice()));
        ...
        holder.setiRecyclerItemSelectedListener(new IRecyclerItemSelectedListener() {
            ...
            public void onItemSelectedListener(View view, int pos) {
                ...
                DatabaseUtits.insertToCart(cartDatabase,cartItem);
